...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Zone.zone_id'
        db.alter_column('zone', 'zone_id', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Block.block_id'
        db.alter_column('block', 'block_id', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Zone.zone_id'
        db.alter_column('zone', 'zone_id', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Block.block_id'
        db.alter_column('block', 'block_id', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'multigtfs.block': {
            ...
            'block_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'db_index': 'True'}),
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['multigtfs.Feed']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        'multigtfs.fare': {
        ...
        'multigtfs.service': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 29, 9, 45, 42, 1)'}),
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['multigtfs.Feed']"}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 29, 9, 45, 42, 1)'}),
        ...
        'multigtfs.servicedate': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 29, 9, 45, 42, 1)'}),
        ...
        'multigtfs.zone': {
            ...
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['multigtfs.Feed']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'zone_id': ('django.db.models.fields.CharField', [], {'max_length': '20', 'db_index': 'True'})
        }
    }
