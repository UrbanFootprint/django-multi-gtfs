...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Trip.short_name'
        db.alter_column('trip', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=20))

    def backwards(self, orm):

        # Changing field 'Trip.short_name'
        db.alter_column('trip', 'short_name', self.gf('django.db.models.fields.CharField')(max_length=10))
    ...
    models = {
        ...
        'multigtfs.service': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 29, 9, 18, 51, 1)'}),
            'feed': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['multigtfs.Feed']"}),
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 29, 9, 18, 51, 1)'}),
        ...
        'multigtfs.servicedate': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 29, 9, 18, 51, 1)'}),
